 ...
 */
public interface WordTime {
    /**
     * The length of a day in milli-seconds
     */
    long DAY_LENGHT = 1000 * 60 * 60 * 24;

    /**
     * The number of timer tick events per day.
     * <p>
     * This must be a divisor of {@link #DAY_LENGHT} to avoid rounding issues.
     */
    long TICK_EVENTS_PER_DAY = 100;

    long TICK_EVENT_RATE = DAY_LENGHT / TICK_EVENTS_PER_DAY;
    ...
    /**
     * World time starts at midnight of the first day being 0, midnight of the seconds day being 1 and so on.
     *
