...
import org.continuum.rendering.Primitives;
...
public class Clouds implements RenderableObject {
    ...
    private void generateClouds() {
        try {
            BufferedImage cloudImage = ImageIO.read(ResourceLoader.getResource("org/continuum/data/textures/clouds.png").openStream());
