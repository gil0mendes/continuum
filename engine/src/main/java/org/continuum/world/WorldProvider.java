...
import org.continuum.world.chunk.ChunkCache;
...
public class WorldProvider {
	...
	public double getTime() {
		long milliSecsSinceCreation = Continuum.getInstance().getTime() - _creationTime;
	...
	public void setTime(double time) {
		_creationTime = Continuum.getInstance().getTime() - (long) (time * DAY_NIGHT_LENGTH_IN_MS);
	}
